 ...
 *
 */
public abstract class WeixinResponse_bak {
	...
	public WeixinResponse_bak(int code,Map<String, List<String>> headers){
	 ...
	 * @return
	 */
	public  String paserErrorToJson(){
		JSONObject json=new JSONObject();
		json.put(ERR_CODE, this.errcode);
		json.put(ERR_MSG, this.errmsg);
